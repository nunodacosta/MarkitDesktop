...
public class FrontendMainWindowHandleBar extends JPanel {
  /**
 ...
 public static ImageIcon imgIcon;
  ...
  public FrontendMainWindowHandleBar() {
  }

  public FrontendMainWindowHandleBar(String varFormName, MainWindow varFormWindow) {
    super();
  ...
  public FrontendMainWindowHandleBar(String varFormName, String varBarName, int varWidth,
                     int varHeight) {
    super();
  ...
  public FrontendMainWindowHandleBar(String varFormName, JLabel varLblIcon, String varBarName, int varWidth,
                     int varHeight) {
    super();
    this.formName = varFormName;
    this.strBarName = varBarName;
 ...
 public FrontendMainWindowHandleBar(String varFormName, ImageIcon varImgIcon, String varBarName, int varWidth,
                     int varHeight) {
    super();
    this.formName = varFormName;
    this.strBarName = varBarName;
  ...
  public FrontendMainWindowHandleBar(String varBarName) {
    super();
    strBarName = varBarName;
    setProperties();
  }
  public FrontendMainWindowHandleBar(String varBarName, ImageIcon varImgIcon) {
    super();
    strBarName = varBarName;
     imgIcon=varImgIcon;
    setProperties();
  }
    public FrontendMainWindowHandleBar(String varBarName, JLabel varLblIcon) {
    super();
    strBarName = varBarName;
    inconLabel= varLblIcon;
    setProperties();
